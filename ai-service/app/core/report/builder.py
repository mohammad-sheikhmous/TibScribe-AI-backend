...
def _to_item(job_id: str, seg: ClassifiedSegment, low_conf_threshold: float) -> ReportItem:
...
def build_report(
    ...
    *,
    ...
    items = [_to_item(job_id, seg, low_confidence_threshold) for seg in ordered]
