...
class Patient extends Model {
    ...
    protected static function booted(): void { static::creating(function (Patient $patient) { $patient->ai_external_id ??= (string) Str::uuid(); }); }
    protected function casts(): array { return ['birth_date'=>'date']; }
    public function doctor(): BelongsTo { return $this->belongsTo(Doctor::class); }
    public function clinicalSessions(): HasMany { return $this->hasMany(ClinicalSession::class); }
