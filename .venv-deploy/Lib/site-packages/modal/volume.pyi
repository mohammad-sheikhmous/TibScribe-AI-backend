...
class _Volume(modal._object._Object):
    ...
    @staticmethod
    def _get_version_proto(version: typing.Optional[int]) -> int: ...
    @staticmethod
    def from_name(
        name: str,
        *,
...
class AbstractVolumeUploadContextManager:
    ...
    def __enter__(self) -> AbstractVolumeUploadContextManager: ...
    async def __aenter__(self) -> AbstractVolumeUploadContextManager: ...
    ...
    _uploader_generators: list[
        collections.abc.Generator[
            collections.abc.Callable[
                ...
                collections.abc.Coroutine[typing.Any, typing.Any, modal._utils.blob_utils.FileUploadSpec2],
            ]
        ]
    ]
...
async def _put_missing_blocks(
    ...
    missing_blocks: collections.abc.Sequence,
